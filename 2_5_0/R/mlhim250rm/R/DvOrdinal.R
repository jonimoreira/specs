...
#'
#' MLHIM 2.5.0 DvOrdinal
#'
#'
#' Returns a data.frame of the collected nodes of a DvOrdinal restriction from the XML fragment.
#'
#' The vectors are:
#'
...
DvOrdinal <- function(pcm) {
  ...
  if (length(pcm) > 0)
  {
    ...
    data <- data.frame(label, vtb, vte,
                       reference_ranges, normal_status, ordinal, symbol,
