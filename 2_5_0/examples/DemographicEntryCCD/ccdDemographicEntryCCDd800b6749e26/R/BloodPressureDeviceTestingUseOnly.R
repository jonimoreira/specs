...
#' The XML element name is pcs-6669a777-2d29-44b6-97ae-4d47c16ee587 as a restriction of the DvString
...
parseBloodPressureDeviceTestingUseOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-6669a777-2d29-44b6-97ae-4d47c16ee587', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvString)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-6669a777-2d29-44b6-97ae-4d47c16ee587'
      data$ccd <- XML::xmlName(root)
