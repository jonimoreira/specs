...
# metadata.R for ccd-6f73b07f-736e-461c-9418-83fb4ca50906.xsd
...
getMetadata <- data.frame(
  ...
  dc_identifier='ccd-6f73b07f-736e-461c-9418-83fb4ca50906',
  dc_description='Testing CCD-Gen Implementation of the MLHIM RM functionality.',
  dc_publisher='MLHIM LAB, UERJ',
  dc_date=as.POSIXct(strptime('2015-08-03 19:0335', '%Y-%m-%d %HH:%MM%SS')),
  dc_format='text/xml',
  dc_language='en-us',
  stringsAsFactors=FALSE)
  
ccduri <- function(){
    return('http://www.ccdgen.com/ccdlib/ccd-6f73b07f-736e-461c-9418-83fb4ca50906.xsd')
}
