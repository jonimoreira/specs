...
#' The XML element name is pcs-5bc6e2e3-1ed7-4624-b71c-0279dd07b960 as a restriction of the DvString
...
parseSystemLocationLatitudeTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-5bc6e2e3-1ed7-4624-b71c-0279dd07b960', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvString)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-5bc6e2e3-1ed7-4624-b71c-0279dd07b960'
      data$ccd <- XML::xmlName(root)
