...
#' The XML element name is pcs-bd49c3de-1978-490a-a8b6-5172b310bea8 as a restriction of the DvString
...
parseZipCodeUSTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-bd49c3de-1978-490a-a8b6-5172b310bea8', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvString)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-bd49c3de-1978-490a-a8b6-5172b310bea8'
      data$ccd <- XML::xmlName(root)
