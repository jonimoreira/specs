...
#' The XML element name is pcs-d078d2a9-3134-45b9-bd69-cbdc0421d562 as a restriction of the DvOrdinal
...
parseKarnofskyPerformanceStatusScoreTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-d078d2a9-3134-45b9-bd69-cbdc0421d562', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvOrdinal)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-d078d2a9-3134-45b9-bd69-cbdc0421d562'
      data$ccd <- XML::xmlName(root)
