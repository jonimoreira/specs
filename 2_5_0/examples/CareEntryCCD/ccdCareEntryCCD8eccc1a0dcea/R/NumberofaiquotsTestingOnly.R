...
#' The XML element name is pcs-13cc8af0-2919-4a66-aa70-4310289f912d as a restriction of the DvCount
...
parseNumberofaiquotsTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-13cc8af0-2919-4a66-aa70-4310289f912d', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvCount)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-13cc8af0-2919-4a66-aa70-4310289f912d'
      data$ccd <- XML::xmlName(root)
