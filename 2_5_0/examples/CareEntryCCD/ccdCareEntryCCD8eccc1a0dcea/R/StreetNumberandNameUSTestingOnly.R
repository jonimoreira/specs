...
#' The XML element name is pcs-18647d15-9ac4-403f-bf25-0bfe203f4fd0 as a restriction of the DvString
...
parseStreetNumberandNameUSTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-18647d15-9ac4-403f-bf25-0bfe203f4fd0', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvString)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-18647d15-9ac4-403f-bf25-0bfe203f4fd0'
      data$ccd <- XML::xmlName(root)
