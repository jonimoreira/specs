...
#' The XML element name is pcs-687bb47c-374e-47eb-8cc7-08b963b84d03 as a restriction of the DvFile
...
parseProofTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-687bb47c-374e-47eb-8cc7-08b963b84d03', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvFile)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-687bb47c-374e-47eb-8cc7-08b963b84d03'
      data$ccd <- XML::xmlName(root)
