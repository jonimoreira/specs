...
#' The XML element name is pcs-312287a3-54a5-49ab-b187-d5b12bf8ff0a as a restriction of the DvString
...
parseCityNameUSTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-312287a3-54a5-49ab-b187-d5b12bf8ff0a', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvString)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-312287a3-54a5-49ab-b187-d5b12bf8ff0a'
      data$ccd <- XML::xmlName(root)
