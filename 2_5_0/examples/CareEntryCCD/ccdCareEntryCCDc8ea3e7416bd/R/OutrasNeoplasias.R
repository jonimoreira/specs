...
#' The XML element name is pcs-c8e5964e-c42d-4872-a249-042563701896 as a restriction of the DvString
...
parseOutrasNeoplasias <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-c8e5964e-c42d-4872-a249-042563701896', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvString)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-c8e5964e-c42d-4872-a249-042563701896'
      data$ccd <- XML::xmlName(root)
