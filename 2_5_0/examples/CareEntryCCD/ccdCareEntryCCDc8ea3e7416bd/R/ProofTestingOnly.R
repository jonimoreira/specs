...
#' The XML element name is pcs-d05fde5b-a2f9-4fd8-aab8-b64d3459e1b8 as a restriction of the DvFile
...
parseProofTestingOnly <- function(sourceName) {
  ...
  pcm <- XML::getNodeSet(root, '//mlhim2:pcs-d05fde5b-a2f9-4fd8-aab8-b64d3459e1b8', nsDEF)
  data <- lapply(pcm, mlhim250rm::DvFile)
  data <- data.table::rbindlist(data, fill=TRUE)
  if (length(data) > 0) { 
      data$ccd <- XML::xmlName(root)
      data$pcs <- 'pcs-d05fde5b-a2f9-4fd8-aab8-b64d3459e1b8'
      data$ccd <- XML::xmlName(root)
