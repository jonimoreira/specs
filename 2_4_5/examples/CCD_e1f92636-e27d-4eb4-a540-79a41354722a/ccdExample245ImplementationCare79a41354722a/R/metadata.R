...
# metadata.R for ccd-e1f92636-e27d-4eb4-a540-79a41354722a.xsd
...
ccduri <- function(){
    return('http://www.ccdgen.com/ccdlib/ccd-e1f92636-e27d-4eb4-a540-79a41354722a.xsd')
}
