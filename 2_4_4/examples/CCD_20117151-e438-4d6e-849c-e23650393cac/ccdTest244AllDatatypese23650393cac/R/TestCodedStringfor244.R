...
#'
#' Returns a data.frame of the collected nodes of: \code{Test CodedString for 2.4.4} from the XML instance passed as fileName.
#' The XML element name is el-de04cb2b-0908-4862-819b-cb1645bf47c3 as a restriction of the mlhim244:DvCodedString
...
#' 
#' Test the DvCodedString Type for RM for 2.4.4
#' 
#' @references
...
#' TestCodedStringfor244 <- getTestCodedStringfor244(files) 
#' 
#' @export
getTestCodedStringfor244 <- function(fileList)
{
    ldata <- lapply(fileList, parseTestCodedStringfor244)
    clean <- ldata[!is.na(ldata)]
    data <- do.call(rbind,clean)
    return(data)
}

parseTestCodedStringfor244 <- function(fileName)
{
  ...
  pct <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3', nsDEF)
  ...
  if (length(pct) > 0)
  {
      ...
      children <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/child::node()', nsDEF)
      if (!is.na(charmatch('mlhim244:',children[[2]]))) # the exceptional value elements are in the RM namespace
      {
        n <- getNodeSet(root, paste('//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/',xmlName(children[[2]]),'/ev-name'), nsDEF)
        ev_name <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/data-name', nsDEF)
      if (length(n) > 0)
      {
        data_name <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/valid-time-begin', nsDEF)
      if (length(n) > 0)
      {
        ds <- xmlValue(n[[1]])
        ds <- gsub('T', ' ', ds)
      ...
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/valid-time-end', nsDEF)
      if (length(n) > 0)
      {
        ds <- xmlValue(n[[1]])
        ds <- gsub('T', ' ', ds)
      ...
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/DvString-dv', nsDEF)
      if (length(n) > 0)
      {
        DvString_dv <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/language', nsDEF)
      if (length(n) > 0)
      {
        language <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/terminology-abbrev', nsDEF)
      if (length(n) > 0)
      {
        terminology_abbrev <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/terminology-name', nsDEF)
      if (length(n) > 0)
      {
        terminology_name <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/terminology-version', nsDEF)
      if (length(n) > 0)
      {
        terminology_version <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-de04cb2b-0908-4862-819b-cb1645bf47c3/terminology-code', nsDEF)
      if (length(n) > 0)
      {
