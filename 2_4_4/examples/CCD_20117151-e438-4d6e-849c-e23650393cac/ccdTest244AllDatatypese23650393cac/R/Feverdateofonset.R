...
#'
#' Returns a data.frame of the collected nodes of: \code{Fever: date of onset} from the XML instance passed as fileName.
#' The XML element name is el-29d84f3a-a351-4328-9252-5d451997cf80 as a restriction of the mlhim244:DvTemporal
...
#' 
#' Date of onset of the symptom fever. It gives the precise lenght of the fever, which is important, since onlu subjects with 3 weeks of fever or less are eligible for this protocol.
#' 
#' @references
...
#' Feverdateofonset <- getFeverdateofonset(files) 
#' 
#' @export
getFeverdateofonset <- function(fileList)
{
    ldata <- lapply(fileList, parseFeverdateofonset)
    clean <- ldata[!is.na(ldata)]
    data <- do.call(rbind,clean)
    return(data)
}

parseFeverdateofonset <- function(fileName)
{
  ...
  pct <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80', nsDEF)
  ...
  if (length(pct) > 0)
  {
      ...
      children <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/child::node()', nsDEF)
      if (!is.na(charmatch('mlhim244:',children[[2]]))) # the exceptional value elements are in the RM namespace
      {
        n <- getNodeSet(root, paste('//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/',xmlName(children[[2]]),'/ev-name'), nsDEF)
        ev_name <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/data-name', nsDEF)
      if (length(n) > 0)
      {
        data_name <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/valid-time-begin', nsDEF)
      if (length(n) > 0)
      {
        ds <- xmlValue(n[[1]])
        ds <- gsub('T', ' ', ds)
      ...
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/valid-time-end', nsDEF)
      if (length(n) > 0)
      {
        ds <- xmlValue(n[[1]])
        ds <- gsub('T', ' ', ds)
      ...
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/normal-status', nsDEF)
      if (length(n) > 0)
      {
        normal_status <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-date', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_date <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-time', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_time <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-datetime', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_datetime <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-day', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_day <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-month', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_month <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-year', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_year <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-year-month', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_year_month <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-month-day', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_month_day <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-duration', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_duration <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-ymduration', nsDEF)
      if (length(n) > 0)
      {
        dvtemporal_ymduration <- xmlValue(n[[1]])
      }
      
      n <- getNodeSet(root, '//ccd:el-29d84f3a-a351-4328-9252-5d451997cf80/dvtemporal-dtduration', nsDEF)
      if (length(n) > 0)
      {
